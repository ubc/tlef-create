    ...
    <div>
      <div className="dashboard-grid">
        <div className="card stat-card">
          <BookOpen size={24} style={{ margin: '0 auto var(--spacing-sm)', color: 'var(--primary)' }} />
          <div className="stat-number">{courses.length}</div>
          <div className="stat-label">Active Courses</div>
        </div>
        
        <div className="card stat-card">
          <FileText size={24} style={{ margin: '0 auto var(--spacing-sm)', color: 'var(--primary)' }} />
          <div className="stat-number">{totalQuizzes}</div>
          <div className="stat-label">Total Quizzes</div>
        </div>
        
        <div className="card stat-card">
          <CheckCircle size={24} style={{ margin: '0 auto var(--spacing-sm)', color: 'var(--primary)' }} />
          <div className="stat-number">{totalQuestions}</div>
          <div className="stat-label">Questions Generated</div>
        </div>
        
        <div className="card stat-card">
          <Clock size={24} style={{ margin: '0 auto var(--spacing-sm)', color: 'var(--primary)' }} />
