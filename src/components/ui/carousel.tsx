  ...
  return (
    <Button
      ...
      className={cn(
        "carousel-button",
        orientation === "horizontal"
          ? "carousel-button-previous-horizontal"
          : "carousel-button-previous-vertical",
        className
      )}
    ...
    >
      ...
      <span className="carousel-sr-only">Previous slide</span>
    </Button>
  )
})
  ...
  return (
    <Button
      ...
      className={cn(
        "carousel-button",
        orientation === "horizontal"
          ? "carousel-button-next-horizontal"
          : "carousel-button-next-vertical",
        className
      )}
    ...
    >
      ...
      <span className="carousel-sr-only">Next slide</span>
    </Button>
  )
})
