...
import "../../../styles/components/ui/dropdown-menu.css"
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight className="dropdown-menu-sub-trigger-icon" />
  </DropdownMenuPrimitive.SubTrigger>
))
  ...
  >
    <span className="dropdown-menu-checkbox-indicator">
      <DropdownMenuPrimitive.ItemIndicator>
        <Check className="dropdown-menu-checkbox-icon" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.CheckboxItem>
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="dropdown-menu-radio-indicator">
      <DropdownMenuPrimitive.ItemIndicator>
        <Circle className="dropdown-menu-radio-icon" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
