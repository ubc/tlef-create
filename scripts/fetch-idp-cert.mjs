 ...
 *   SAML_METADATA_URL  (default: http://localhost:8080/simplesaml/saml2/idp/metadata.php)
 *   SAML_CERT_PATH     (default: ../docker-simple-saml/cert/server.crt)
 *
...
const outPath = process.env.SAML_CERT_PATH || '../docker-simple-saml/cert/server.crt';
