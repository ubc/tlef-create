        ...
        if (parameters && parameters.bookCover && parameters.bookCover.coverDescription) {
          ...
          for (let i = 1; i < tables.length; i++) {
            ...
            if (tableChanges) {
              ...
              const substring = tables[i].substring(0, tagEnd);
            ...
            if (cellChanges) {
              ...
              const headers = tables[i].split(/<th(?!ead)/);
              tables[i] = headers[0];
              ...
              for (let j = 1; j < headers.length; j++) {
                ...
                const substring = headers[j].substring(0, tagEnd);
              ...
              for (let j = 1; j < cells.length; j++) {
                ...
                const substring = cells[j].substring(0, tagEnd);
