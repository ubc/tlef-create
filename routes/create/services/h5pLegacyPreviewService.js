// Restored from h5pPreviewController.js before bbe19a7: one shared minimal
...
export async function renderLegacyH5PPreview(quiz, questions, containerMode = 'column') {
...
${jsTags}
  <script>
    jQuery(document).ready(function() {
      var library = ${JSON.stringify(h5pLibrary).replace(/</g, '\\u003c')};
...
(function () {
  function reportHeight() {
    window.parent.postMessage({type: 'tlef:h5p-preview-height', height: document.body.scrollHeight}, '*');
  }
